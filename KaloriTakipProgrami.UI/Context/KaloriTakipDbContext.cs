...
namespace KaloriTakipProgrami.UI.Context
{
    ...
    // ...
    new KullaniciDetay { Id = 37, Boy = 175.0m, Kilo = 53.7m, Tarih = new DateTime(2023, 3, 29), KullaniciId = 37 },
    new KullaniciDetay { Id = 38, Boy = 180.7m, Kilo = 99.5m, Tarih = new DateTime(2023, 3, 17), KullaniciId = 38 },
    new KullaniciDetay { Id = 39, Boy = 163.2m, Kilo = 77.7m, Tarih = new DateTime(2021, 9, 12), KullaniciId = 39 },
    new KullaniciDetay { Id = 40, Boy = 163.9m, Kilo = 63.6m, Tarih = new DateTime(2024, 6, 27), KullaniciId = 40 },
    new KullaniciDetay { Id = 41, Boy = 153.7m, Kilo = 69.7m, Tarih = new DateTime(2024, 2, 20), KullaniciId = 41 },
    new KullaniciDetay { Id = 42, Boy = 169.6m, Kilo = 55.3m, Tarih = new DateTime(2021, 6, 8), KullaniciId = 42 },
    new KullaniciDetay { Id = 43, Boy = 150.0m, Kilo = 84.1m, Tarih = new DateTime(2023, 4, 28), KullaniciId = 43 },
    new KullaniciDetay { Id = 44, Boy = 153.1m, Kilo = 54.8m, Tarih = new DateTime(2024, 5, 24), KullaniciId = 44 },
    new KullaniciDetay { Id = 45, Boy = 170.3m, Kilo = 80.6m, Tarih = new DateTime(2023, 11, 17), KullaniciId = 45 },
    new KullaniciDetay { Id = 46, Boy = 159.3m, Kilo = 57.0m, Tarih = new DateTime(2024, 3, 14), KullaniciId = 46 },
    new KullaniciDetay { Id = 47, Boy = 162.3m, Kilo = 78.2m, Tarih = new DateTime(2023, 10, 1), KullaniciId = 47 },
    new KullaniciDetay { Id = 48, Boy = 179.5m, Kilo = 84.8m, Tarih = new DateTime(2025, 3, 2), KullaniciId = 48 },
    new KullaniciDetay { Id = 49, Boy = 158.1m, Kilo = 86.1m, Tarih = new DateTime(2025, 3, 14), KullaniciId = 49 },
    new KullaniciDetay { Id = 50, Boy = 181.2m, Kilo = 74.6m, Tarih = new DateTime(2021, 1, 31), KullaniciId = 50 }
);
            {
                base.OnModelCreating(modelBuilder);
